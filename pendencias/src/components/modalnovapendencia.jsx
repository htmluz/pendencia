                            ...
                            <form method='POST' onSubmit={handleSubmit}>
                                <div className='flex flex-col space-between font-system font-semibold'>
                                    ...
                                    <div className='flex w-90% py-2 border-b-2 border-[#efefef] pb-3'>
                                        <input value={formData.massiva} onChange={handleInputChange} type='checkbox' className='peer mt-1 mr-2 w-4 h-4 rounded focus:ring-0 bg-[#efefef] checked:bg-[#dddddd] appearance-none transition-all' name='massiva' id='massiva' />
