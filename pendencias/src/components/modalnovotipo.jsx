            ...
            <div className='bg-white w-1/4 mt-20 ml-auto mr-auto rounded p-4 pb-0 shadow-modal'>
                    <div className='relative flex flex-col w-full pointer-events-auto p-5 pb-8'>
                        ...
                        <form onSubmit={handleSubmit} className="font-system font-semibold" method='POST'>
                            <div className=" pb-3">
                                <input required id="tipo" onChange={handleInputChange} name="tipo" type="text" className='font-normal px-2 mt-2 transition-colors focus:outline-none focus:bg-[#dddddd] leading-9 bg-[#efefef] rounded w-full' />
                            </div>
                            <div className="mt-3">
